...
const i18n = {
    en: {
        ...
        desktopKicker: 'Desktop application',
        desktopTitle: 'Prefer a standalone flasher?',
        desktopText: 'Download 2MQTT-Flasher for Windows, macOS, or Linux.',
        desktopAction: 'Go to download',
    ...
    de: {
        ...
        desktopKicker: 'Desktop-Anwendung',
        desktopTitle: 'Lieber ein eigenständiger Flasher?',
        desktopText: '2MQTT-Flasher für Windows, macOS oder Linux herunterladen.',
        desktopAction: 'Zum Download',
